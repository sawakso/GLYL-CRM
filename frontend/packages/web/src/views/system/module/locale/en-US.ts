export default {
  ...
  'module.clue.baseInfo': 'Basic Info',
  'module.clue.ruleSetting': 'Rule Settings',
  'module.clue.displaySetting': 'Display Settings',
  'module.clue.otherSetting': 'Other',
  'module.clue.pickMode': 'Allocation Rule',
  'module.clue.pickModeVisible': 'Members can view and pick, admin can assign',
  'module.clue.pickModeAdminOnly': 'Members cannot view, admin can assign',
  'module.clue.newLeadRemind': 'New Lead Reminder',
  'module.clue.newLeadRemindTip': 'Push to-do to admins for new leads for timely assignment',
  'module.clue.assignRule': 'Lead Pool Assignment Rule',
  'module.clue.assignRuleTip': 'Auto-assign to specified personnel based on lead fields',
  'module.clue.ruleName': 'Rule Name',
  'module.clue.assignType': 'Assignment Type',
  'module.clue.assignSingle': 'Assign to one person',
  'module.clue.assignRoundRobin': 'Round-robin assignment',
  'module.clue.matchCondition': 'Match Condition',
  'module.clue.targetUser': 'Target User',
  'module.clue.addRule': 'Add Rule',
  'module.clue.priority': 'Priority {number}',
  'module.clue.moveUp': 'Move up',
  'module.clue.moveDown': 'Move down',
  'module.clue.copyRule': 'Copy',
  'module.clue.addCondition': 'Add Condition',
  'module.clue.fieldName': 'Field',
  'module.clue.operator': 'Operator',
  'module.clue.operatorEquals': 'Equals',
  ...
  'module.clue.timeoutRemind': 'Timeout Reminder',
  'module.clue.unassignedReminder': 'Unassigned after pool entry',
  'module.clue.unfollowedReminder': 'Unfollowed after collection',
  'module.clue.notifyPoolAdminOnUnfollowedTimeout': 'Notify pool admins when follow-up times out',
  'module.clue.hour': 'hour(s)',
  'module.clue.minute': 'minute(s)',
  'module.clue.transferReturn': 'Lead Transfer / Return Rules',
  'module.clue.allowTransferAfterPick': 'Allow transfer after a lead is collected',
  'module.clue.restrictTransferInToMembers': 'Only allow transfer to members of this pool',
  'module.clue.restrictReturnToMembers': 'Only allow return to members of this pool',
  'module.clue.clearRule': 'Clear Rule',
  'module.clue.clearTeamOnOwnerChange': 'Clear the team when the owner changes',
  'module.clue.clearExternalOwnerOnOwnerEmpty': 'Clear the external owner when the owner is empty',
  'module.clue.clearExternalTeamOnExternalOwnerEmpty': 'Clear the external team when the external owner is empty',
  'module.clue.clearOwnerOnPoolTransfer': 'Clear the owner when transferring between pools',
  'module.clue.clearExternalOwnerOnPoolTransfer': 'Clear the external owner when transferring between pools',
  'module.clue.fieldPermissionSetting': 'Public / Private Field Settings',
  'module.clue.fieldPermissionTip': 'Move fields to Public to show them before collection. Name must remain public.',
  'module.clue.privateFields': 'Private Fields',
  'module.clue.publicFields': 'Public Fields',
  'module.clue.otherPermissions': 'Other Permissions',
  'module.clue.allowViewChangeLogBeforePick': 'Allow viewing change history before collection',
  'module.clue.allowEditTeamBeforePick': 'Allow editing the team before collection',
  'module.clue.allowSendSalesRecordBeforePick': 'Allow sending sales records before collection',
  'module.clue.allowViewSalesRecordBeforePick': 'Allow viewing sales records before collection',
  'module.clue.allowViewPoolLog': 'Allow viewing lead pool logs',
  'module.clue.currentClueCount': 'Current Lead Count',
  'module.clue.lastUpdateTime': 'Last Modified Time',
  'module.clue.noAssignRules': 'No assignment rules, click "Add Rule" to create',
  ...
  'module.clue.description': 'Description',
